...
SFX have captions. Radio is occasional optional texture, never the campaign's
constant narrator. Scene references, line IDs, localization text, voice choices,
generation receipts, and asset revisions must stay linked through production.
