...
| [`multiplayer-maps.md`](./multiplayer-maps.md) | **planned** | Rule sheet for multiplayer maps, sixteen proposed maps from duel rooms to conquest-lite fronts, a verdict on the six current maps, and the mode order. |
