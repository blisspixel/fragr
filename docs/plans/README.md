...
|---|---|---|
| [`display-quality.md`](./display-quality.md) | **in flight** | Fullscreen default, real resolution selection and portable graphics presets through the shared settings panel. |
