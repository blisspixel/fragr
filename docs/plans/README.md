...
|---|---|---|
| [`tripoint-spawn-safety.md`](./tripoint-spawn-safety.md) | **implemented** (#194) | Cover the exposed starting ring, prove all 16 routes and sightlines, and retain measured respawn limitations. |
