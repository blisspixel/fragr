...
| [`m01-completion.md`](./m01-completion.md) | **in flight** (#195) | Routes, balcony, departure, leave warning, and published room stills shipped through v0.40.0. Next is two readable enemies. Secrets, saves, and a fresh-player review remain. |
