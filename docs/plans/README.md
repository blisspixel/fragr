...
| [`campaign-scenes.md`](./campaign-scenes.md) | **in flight** | Audio slideshows between levels: a data-driven scene player (M01 opening migrated, first interlude drafted), the twenty-three scene list, per-batch spend gates and the later video path on the same shots. |
