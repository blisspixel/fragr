...
|---|---|---|
| [`tripoint-spawn-safety.md`](./tripoint-spawn-safety.md) | **in flight** (#194) | Investigate recurring early deaths under the unchanged 16-client gate; prove the spatial or lifecycle fix. |
