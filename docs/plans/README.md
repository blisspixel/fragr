...
| [`m01-completion.md`](./m01-completion.md) | **in flight** (#195) | Routes through v0.40.0. Clerk and Sweeper silhouettes now separate without a new purchase. Next is an optional secret, then a fresh-player review. |
