...
|---|---|---|
| [`jev-budget-reservations.md`](./jev-budget-reservations.md) | **implemented** ([#218](https://github.com/blisspixel/fragr/pull/218)) | Durable pre-send Jev receipts and one shared paid request at a time, with recovery and no-ledger refusal. |
