...
| [`campaign-scenes.md`](./campaign-scenes.md) | **in flight** | Audio cutscenes between levels: a data-driven scene player (M01 opening migrated, first interlude drafted), narration over one key image per scene, the twenty-three scene list, costs and per-batch spend gates. |
