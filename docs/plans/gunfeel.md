...
| Scatter | 40 / 0.45 s / one ray in 0.20 / 12 (2026-09-19 to 09-24) | **shipped 2026-09-24**: 7 pellets of 10 / 0.60 s / 0.095 per pellet / 12 / each pellet full to 4 units then linear to 0.35x at 12 / 0.20 s switch | Two full blasts kill bare in 0.60 s, three through full armour in 1.20 s. The old single ray in an 11 degree cone often missed a body at arm's length; seven pellets in 5.4 degrees all land at four units and about half at eight. Doom's count; banded falloff follows Titanfall 2 and Counter-Strike. See [`boomer-ammo-and-pellets.md`](./boomer-ammo-and-pellets.md). |
