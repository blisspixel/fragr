...
decisions already approved by Nick.

| Act | Missions | Story change | Why travel follows |
|---|---|---|---|
...
missing recent experiences; no surprise spare copy cancels a sacrifice.
...
belongs in the first mission; the broader [locale rollout](plans/localization.md)
