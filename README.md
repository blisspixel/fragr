...
The current release is [v0.50.1](https://github.com/blisspixel/fragr/releases/tag/v0.50.1). Shipped tags are listed in [CHANGELOG.md](CHANGELOG.md). What is still open is [docs/ROADMAP.md](docs/ROADMAP.md).
